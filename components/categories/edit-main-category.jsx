...
import { CATEGORY_EDITED_SUCCESSFULLY } from '@/data/messages'
...
export default function EditMainCategory({ isOpen, closeModal, item }) {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      if (result.success) {
        toast.success(CATEGORY_EDITED_SUCCESSFULLY);
      }
    } catch (error) {
